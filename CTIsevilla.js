...
function ctiSocket(station) {
    try {
        ...
        RESTError(data, url);
        alert("No puedo conectarse al Socket.... validelo con el administrador del sistema.");
    }
}
...
function fconnecting(data) {
    try {
        ...
        if ($("#Builder_Engine .btn-engine-done").length > 0) {
            ...
            document.getElementById("iframedataset").src = "http://172.18.149.21/WEB_Fusion/Agente/dataset.html?clientesId=&vclave=" + sDNIS;
        }
    ...
    try {
        ...
        if (BanderaConecting == 0 && BanderaStablished == 0) {
            ...
            if ($("#Builder_Engine .btn-engine-done").length > 0) {
                ...
                document.getElementById("iframedataset").src = "http://172.18.149.21/WEB_Fusion/Agente/dataset.html?clientesId=&vclave=" + sANI;
            }
        }
